...
const WriteOffWork = ({ isDialogOpen, handleDialogClose, writeOffInfo, writeOffDetail, writeOffInitQuery, action, setCBWriteOff, cBWriteOff }) => {
    ...
    const changeBankFee = (bankFee, id) => {
        ...
        tmpArray.forEach((i) => {
            if (i.BillDetailID === id) {
                let tmpBRAmount = Number(i.ReceiveAmount.toString().replaceAll(',', '')) + Number(bankFee.toString().replaceAll(',', '')) + (Number(i.CBWriteOffAmount?.toString().replaceAll(',', '')) || 0);
                i.BankFee = Number(bankFee.toString().replaceAll(',', ''));
                i.BRAmount = tmpBRAmount;
                i.OverAmount = (Number(i.ReceiveAmount.toString().replaceAll(',', '')) + (Number(i.CBWriteOffAmount?.toString().replaceAll(',', '')) || 0) + Number(i.ReceivedAmount.toString().replaceAll(',', ''))) - Number(i.FeeAmount.toString().replaceAll(',', ''))
                    <= 0 ? 0 : 
    ...
    const changeReceiveAmount = (receiveAmount, id) => {
        ...
        tmpArray.forEach((i) => {
            if (i.BillDetailID === id) {
                let tmpBRAmount = Number(i.BankFee.toString().replaceAll(',', '')) + Number(receiveAmount.toString().replaceAll(',', '')) + (Number(i.CBWriteOffAmount?.toString().replaceAll(',', '')) || 0);
                i.ReceiveAmount = Number(receiveAmount.toString().replaceAll(',', ''));
                i.BRAmount = tmpBRAmount;
                i.OverAmount = (Number(receiveAmount.toString().replaceAll(',', '')) + (Number(i.CBWriteOffAmount?.toString().replaceAll(',', '')) || 0) + Number(i.ReceivedAmount.toString().replaceAll(',', ''))) - Number(i.FeeAmount.toString().replaceAll(',', '')) 
                    <= 0 ? 0 : 
    ...
    const initData = () => {
        ...
        if(action === 'view') {
            tmpArray.forEach((i) => {
                ...
                i.OverAmount = (Number(i.ReceiveAmount.toString().replaceAll(',', '')) + (Number(i.CBWriteOffAmount?.toString().replaceAll(',', '')) || 0) + Number(i.ReceivedAmount.toString().replaceAll(',', ''))) - Number(i.FeeAmount.toString().replaceAll(',', '')) 
                    <= 0 ? 0 : 
                (Number(i.ReceiveAmount.toString().replaceAll(',', '')) +  (Number(i.CBWriteOffAmount?.toString().replaceAll(',', '')) || 0) + Number(i.ReceivedAmount.toString().replaceAll(',', ''))) - Number(i.FeeAmount.toString().replaceAll(',', ''));
                i.ShortAmount = Number(i.FeeAmount.toString().replaceAll(',', '')) -  Number(i.ReceivedAmount.toString().replaceAll(',', '')) -  Number(i.BankFees.toString().replaceAll(',', '')) - Number(i.BRAmount.toString().replaceAll(',', '')) -  (Number(i.CBWriteOffAmount?.toString().replaceAll(',', '')) || 0)
                    <= 0 ? 0 :
                Number(i.FeeAmount.toString().replaceAll(',', '')) -  Number(i.ReceivedAmount.toString().replaceAll(',', '')) -  Number(i.BankFees.toString().replaceAll(',', '')) - Number(i.BRAmount.toString().replaceAll(',', '')) -  (Number(i.CBWriteOffAmount?.toString().replaceAll(',', '')) || 0) ?? 0;
            });
            ...
            tmpArray.forEach((i) => {
                ...
                i.ShortAmount = Number(i.FeeAmount.toString().replaceAll(',', '')) -  Number(i.ReceivedAmount.toString().replaceAll(',', '')) -  Number(i.BankFees.toString().replaceAll(',', '')) - Number(i.BRAmount.toString().replaceAll(',', '')) -  (Number(i.CBWriteOffAmount?.toString().replaceAll(',', '')) || 0)
                    <= 0 ? 0 :
                Number(i.FeeAmount.toString().replaceAll(',', '')) -  Number(i.ReceivedAmount.toString().replaceAll(',', '')) -  Number(i.BankFees.toString().replaceAll(',', '')) - Number(i.BRAmount.toString().replaceAll(',', '')) -  (Number(i.CBWriteOffAmount?.toString().replaceAll(',', '')) || 0);
            });
            orgFeeAmountTotal.current = tmpOrgFeeAmountTotal; //原始費用
            dedAmountTotal.current = tmpDedAmountTotal; //折扣
            feeAmountTotal.current = tmpFeeAmountTotal; //應收
                                    ...
                                    <Table stickyHeader>
                                        <TableHead>
                                            <TableRow>
                                                ...
                                                {action === 'view' ? '' : <StyledTableCell align="center">CB折抵</StyledTableCell>}
                                                ...
                                                {action === 'view' ? '' : <StyledTableCell align="center">Action</StyledTableCell>}
                                            </TableRow>
                                        </TableHead>
                                        <TableBody>
                                                ...
                                                return (
                                                    ...
                                                    >
                                                        ...
                                                        {action === 'view' ? (
                                                            ...
                                                            <TableCell align="center">
                                                                {handleNumber(row?.CBWriteOffAmount?.toFixed(2))}
                                                            </TableCell>
                                                        )}
                                                        {/* 本次總金額 */}
                                                        {action === 'view' ? (
