        ...
        i.ShortAmount =
          ...
          0
            ...
            : Number(i.FeeAmount.toString().replaceAll(',', '')) -
                ...
                Number(i.BankFees.toString().replaceAll(',', '')) -
                Number(i.BRAmount.toString().replaceAll(',', '')) -
                (Number(i.CBWriteOffAmount?.toString().replaceAll(',', '')) || 0) ?? 0;
      });
                  ...
                  <Table stickyHeader>
                    <TableHead>
                      <TableRow>
                        ...
                        {action === 'view' ? null : (
                          <StyledTableCell align="center">本次手續費</StyledTableCell>
                        )}
                        {action === 'view' ? null : (
                        ...
                        {action === 'view' ? null : (
                          <StyledTableCell align="center">本次總金額</StyledTableCell>
                        )}
                    ...
                    <TableBody>
                      {toWriteOffDetailInfo?.map((row, id) => {
                        tmpBankFee =
                          tmpBankFee + Number(row.BankFee.toString().replaceAll(',', '')); //本次手續費
                        tmpreceiveAmount =
                          tmpreceiveAmount +
                          Number(row.ReceiveAmount.toString().replaceAll(',', '')); //本次實收
