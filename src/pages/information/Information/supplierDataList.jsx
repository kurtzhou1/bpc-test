  ...
  const addSupplierInfo = () => {
    ...
    fetch(suppliers, {
      ...
      .then(() => {
        dispatch(
          setMessageStateOpen({
            messageStateOpen: { isOpen: true, severity: 'success', message: '新增供應商資料成功' },
          }),
        );
        infoInit();
        querySuppliersInfo();
  ...
  const deleteSupplierInfo = (row) => {
    fetch(deleteSuppliers, {
      ...
      .then(() => {
        dispatch(
          setMessageStateOpen({
            messageStateOpen: { isOpen: true, severity: 'success', message: '刪除供應商資料成功' },
          }),
        );
        querySuppliersInfo();
      })
  ...
  const saveEditSupplierInfo = () => {
    ...
    fetch(editSuppliers, {
      ...
      .then((data) => {
        dispatch(
          setMessageStateOpen({
            messageStateOpen: { isOpen: true, severity: 'success', message: '更新供應商資料成功' },
          }),
        );
        editInfoInit();
        querySuppliersInfo();
