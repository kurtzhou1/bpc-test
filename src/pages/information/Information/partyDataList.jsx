  ...
  const addPartyInfo = () => {
    ...
    fetch(parties, {
      ...
      .then(() => {
        dispatch(
          setMessageStateOpen({
            messageStateOpen: { isOpen: true, severity: 'success', message: '新增會員資料成功' },
          }),
        );
        infoInit();
        queryPartiesInfo();
  ...
  const deletePartyInfo = (row) => {
    fetch(deleteParties, {
      ...
      .then(() => {
        dispatch(
          setMessageStateOpen({
            messageStateOpen: { isOpen: true, severity: 'success', message: '刪除會員資料成功' },
          }),
        );
        queryPartiesInfo();
      })
  ...
  const saveEditPartyInfo = () => {
    ...
    fetch(editParties, {
      ...
      .then(() => {
        dispatch(
          setMessageStateOpen({
            messageStateOpen: { isOpen: true, severity: 'success', message: '更新會員資料成功' },
          }),
        );
        editInfoInit();
        queryPartiesInfo();
