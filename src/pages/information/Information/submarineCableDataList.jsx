  ...
  const addPartyInfo = () => {
    ...
    fetch(submarineCables, {
      ...
      .then(() => {
        dispatch(
          setMessageStateOpen({
            messageStateOpen: { isOpen: true, severity: 'success', message: '新增海纜資料成功' },
          }),
        );
        infoInit();
  ...
  const deletePartyInfo = (row) => {
    fetch(deleteSubmarineCables, {
      ...
      .then(() => {
        dispatch(
          setMessageStateOpen({
            messageStateOpen: { isOpen: true, severity: 'success', message: '刪除海纜資料成功' },
          }),
        );
        querySubmarineCablesInfo();
      })
  ...
  const saveEditPartyInfo = () => {
    ...
    fetch(editSubmarineCables, {
      ...
      .then(() => {
        dispatch(
          setMessageStateOpen({
            messageStateOpen: { isOpen: true, severity: 'success', message: '更新海纜資料成功' },
          }),
        );
        editInfoInit();
        querySubmarineCablesInfo();
