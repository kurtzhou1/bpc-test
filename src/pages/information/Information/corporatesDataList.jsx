  ...
  const addPartyInfo = () => {
    ...
    fetch(corporates, {
      ...
      .then(() => {
        dispatch(
          setMessageStateOpen({
            messageStateOpen: { isOpen: true, severity: 'success', message: '新增聯盟資料成功' },
          }),
        );
        infoInit();
        queryCorporatesInfo();
  ...
  const deletePartyInfo = (row) => {
    fetch(deleteCorporates, {
      ...
      .then(() => {
        dispatch(
          setMessageStateOpen({
            messageStateOpen: { isOpen: true, severity: 'success', message: '刪除聯盟資料成功' },
          }),
        );
        queryCorporatesInfo();
      })
  ...
  const saveEditPartyInfo = () => {
    ...
    fetch(editCorporates, {
      ...
      .then(() => {
        dispatch(
          setMessageStateOpen({
            messageStateOpen: { isOpen: true, severity: 'success', message: '更新聯盟資料成功' },
          }),
        );
        editInfoInit();
        queryCorporatesInfo();
