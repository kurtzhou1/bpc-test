...
export const dropdownmenuSubmarineCable = `http://${env}/api/v1/dropdownmenuSubmarineCable`;
...
export const journalDetailView = `http://${env}/api/v1/InvoiceDetail`;
export const journalMasterView = `http://${env}/api/v1/InvoiceWKMaster`;
