...
// 查詢發票工作檔狀態
export const queryInvoice = `${httpEnv}://${env}/api/v1/getInvoiceWKMaster&InvoiceWKDetail`;
...
// 立帳的發票查詢
export const sendJounary = `${httpEnv}://${env}/api/v1/addInvoiceMaster&InvoiceDetail`;
...
// export const addPartiesByContract = `${httpEnv}://${env}/api/v1/PartiesByContract`;
// export const deletePartiesByContract = `${httpEnv}://${env}/api/v1/deletePartiesByContract`;
// export const editPartiesByContract = `${httpEnv}://${env}/api/v1/updatePartiesByContract`;
...
export const submarineCableLiabilityList = `${httpEnv}://${env}/api/v1/dropdownmenuSubmarineCable`;
...
export const journaryDetailView = `${httpEnv}://${env}/api/v1/InvoiceDetail`;
export const journaryMasterView = `${httpEnv}://${env}/api/v1/InvoiceWKMaster`;
